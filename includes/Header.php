...
if (!isset($seo_image))
  $seo_image = $protocol . "://" . $domain . "/guiaempresarial.pe/assets/img/image.png";
if (!isset($seo_url))
          ...
          <?php if (isset($_SESSION['usuario_publico_id'])): ?>
            <a href="mi_cuenta.php" class="nav-link" style="display:flex;align-items:center;gap:8px;">
              <?php if (!empty($_SESSION['usuario_publico_foto'])): ?>
                <img src="assets/img/avatars/<?= htmlspecialchars($_SESSION['usuario_publico_foto']) ?>" alt="Foto perfil"
