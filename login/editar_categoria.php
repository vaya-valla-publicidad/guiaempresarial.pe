...
<head>
    ...
    <style>
        ...
        .icono-preview i { font-size: 36px; color: #E63946; transition: 0.3s; }
        .icono-preview span { font-size: 13px; color: #666; }
        .icono-buscador {
        ...
        .icono-buscador:focus { border-color: #E63946; box-shadow: 0 0 0 3px rgba(230,57,70,0.1); }
        .iconos-grid {
        ...
        .icono-btn {
            ...
            gap: 5px; padding: 10px 8px; width: 80px;
            border: 1px solid #ddd; border-radius: 10px;
            cursor: pointer; background: #fff;
            transition: 0.2s; text-align: center;
        }
        .icono-btn:hover { border-color: #E63946; background: #fff5f5; }
        .icono-btn.activo { border-color: #E63946; background: #fff5f5; box-shadow: 0 0 0 2px rgba(230,57,70,0.2); }
        .icono-btn i { font-size: 24px; color: #1B3A57; }
        .icono-btn.activo i { color: #E63946; }
        .icono-btn span { font-size: 10px; color: #888; line-height: 1.2; }
        .iconos-sin-resultados { padding: 20px; text-align: center; color: #aaa; font-size: 13px; width: 100%; }
    </style>
</head>
<body>
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <div class="icono-preview">
                    <i class="bi <?= htmlspecialchars($cat['icono'] ?? 'bi-briefcase') ?>" id="icono-preview-icon"></i>
