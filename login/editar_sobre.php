    ...
    <div class="form-container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <textarea name="quienes_somos" rows="4"><?= htmlspecialchars($info['quienes_somos'] ?? '') ?></textarea>
            </div>
            <div class="form-group">
                <label>Misión</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="por_que_1_titulo" value="<?= htmlspecialchars($info['por_que_1_titulo'] ?? '') ?>">
            </div>
            <div class="form-group">
                <label>Texto 1</label>
                <textarea name="por_que_1_texto" rows="3"><?= htmlspecialchars($info['por_que_1_texto'] ?? '') ?></textarea>
            </div>

            <div class="form-group">
                <label>Título 2</label>
                <input type="text" name="por_que_2_titulo" value="<?= htmlspecialchars($info['por_que_2_titulo'] ?? '') ?>">
            </div>
            <div class="form-group">
                <label>Texto 2</label>
                <textarea name="por_que_2_texto" rows="3"><?= htmlspecialchars($info['por_que_2_texto'] ?? '') ?></textarea>
            </div>

            <div class="form-group">
                <label>Título 3</label>
                <input type="text" name="por_que_3_titulo" value="<?= htmlspecialchars($info['por_que_3_titulo'] ?? '') ?>">
            </div>
            <div class="form-group">
                <label>Texto 3</label>
                <textarea name="por_que_3_texto" rows="3"><?= htmlspecialchars($info['por_que_3_texto'] ?? '') ?></textarea>
            </div>
